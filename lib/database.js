...
const categories = ['all', 'html', 'javascript', 'css'];

const APIparts = ['snippet', 'contentDetails', 'statistics'];
//contentDetails: duration, caption: "false"
// statistics: viewCount, likeCount, dislikeCount, commentCount

export { ourVideos, categories, APIparts };
